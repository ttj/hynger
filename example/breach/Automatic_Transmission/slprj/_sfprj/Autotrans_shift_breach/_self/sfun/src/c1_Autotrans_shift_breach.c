...
static void initialize_c1_Autotrans_shift_breach
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance);
static void initialize_params_c1_Autotrans_shift_breach
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance);
static void enable_c1_Autotrans_shift_breach
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance);
static void disable_c1_Autotrans_shift_breach
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_Autotrans_shift_breach
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_Autotrans_shift_breach
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance);
static void set_sim_state_c1_Autotrans_shift_breach
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void c1_set_sim_state_side_effects_c1_Autotrans_shift_breach
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance);
static void finalize_c1_Autotrans_shift_breach
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance);
static void sf_gateway_c1_Autotrans_shift_breach
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance);
static void initSimStructsc1_Autotrans_shift_breach
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance);
static void c1_gear_state(SFc1_Autotrans_shift_breachInstanceStruct
  *chartInstance);
static void c1_selection_state(SFc1_Autotrans_shift_breachInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static int32_T c1_emlrt_marshallIn(SFc1_Autotrans_shift_breachInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_b_emlrt_marshallIn(SFc1_Autotrans_shift_breachInstanceStruct
  *chartInstance, const mxArray *c1_b_tp_gear_state, const char_T *c1_identifier);
static uint8_T c1_c_emlrt_marshallIn(SFc1_Autotrans_shift_breachInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_d_emlrt_marshallIn(SFc1_Autotrans_shift_breachInstanceStruct
  *chartInstance, const mxArray *c1_gear, const char_T *c1_identifier);
static real_T c1_e_emlrt_marshallIn(SFc1_Autotrans_shift_breachInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint32_T c1_f_emlrt_marshallIn(SFc1_Autotrans_shift_breachInstanceStruct *
  chartInstance, const mxArray *c1_b_temporalCounter_i1, const char_T
  *c1_identifier);
static uint32_T c1_g_emlrt_marshallIn(SFc1_Autotrans_shift_breachInstanceStruct *
  chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static const mxArray *c1_i_emlrt_marshallIn
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance, const mxArray *c1_u,
   const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_Autotrans_shift_breachInstanceStruct
  *chartInstance);
  ...
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_temporalCounter_i1 = 0U;
  chartInstance->c1_is_active_c1_Autotrans_shift_breach = 0U;
  ...
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_Autotrans_shift_breach == 1U) {
  ...
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_Autotrans_shift_breach;
   ...
   *c1_st)
{
  ...
  *c1_gear = c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
    0)), "gear");
  chartInstance->c1_is_active_c1_Autotrans_shift_breach = c1_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_Autotrans_shift_breach");
  ...
  c1_update_debugger_state_c1_Autotrans_shift_breach(chartInstance);
  ...
  (SFc1_Autotrans_shift_breachInstanceStruct *chartInstance)
{
  ...
  c1_set_sim_state_side_effects_c1_Autotrans_shift_breach(chartInstance);
  ...
  if (chartInstance->c1_is_active_c1_Autotrans_shift_breach == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_c1_Autotrans_shift_breach = 1U;
  ...
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_Autotrans_shift_breachMachineNumber_,
...
const mxArray *sf_c1_Autotrans_shift_breach_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_Autotrans_shift_breachInstanceStruct *chartInstance;
  chartInstance = (SFc1_Autotrans_shift_breachInstanceStruct *)chartInstanceVoid;
...
void sf_c1_Autotrans_shift_breach_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_Autotrans_shift_breach_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_Autotrans_shift_breach_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_Autotrans_shift_breach_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_Autotrans_shift_breach(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[25],T\"gear\",},{M[8],M[0],T\"is_active_c1_Autotrans_shift_breach\",},{M[8],M[2],T\"is_active_gear_state\",},{M[8],M[7],T\"is_active_selection_state\",},{M[9],M[2],T\"is_gear_state\",},{M[9],M[7],T\"is_selection_state\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"wu\",M1x2[1 8],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Autotrans_shift_breach_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_Autotrans_shift_breachInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_Autotrans_shift_breachMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_Autotrans_shift_breachMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _Autotrans_shift_breachMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c1_Autotrans_shift_breach(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_Autotrans_shift_breachInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_Autotrans_shift_breach
    ((SFc1_Autotrans_shift_breachInstanceStruct*) chartInstanceVar);
  initialize_c1_Autotrans_shift_breach
    ((SFc1_Autotrans_shift_breachInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_Autotrans_shift_breach(void *chartInstanceVar)
{
  enable_c1_Autotrans_shift_breach((SFc1_Autotrans_shift_breachInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_Autotrans_shift_breach(void *chartInstanceVar)
{
  disable_c1_Autotrans_shift_breach((SFc1_Autotrans_shift_breachInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_Autotrans_shift_breach(void *chartInstanceVar)
{
  sf_gateway_c1_Autotrans_shift_breach
    ((SFc1_Autotrans_shift_breachInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_Autotrans_shift_breach
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_Autotrans_shift_breach
    ((SFc1_Autotrans_shift_breachInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_Autotrans_shift_breach();/* state var info */
...
extern void sf_internal_set_sim_state_c1_Autotrans_shift_breach(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_Autotrans_shift_breach();/* state var info */
  ...
  set_sim_state_c1_Autotrans_shift_breach
    ((SFc1_Autotrans_shift_breachInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_Autotrans_shift_breach
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_Autotrans_shift_breach(S);
}

static void sf_opaque_set_sim_state_c1_Autotrans_shift_breach(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_Autotrans_shift_breach(S, st);
}

static void sf_opaque_terminate_c1_Autotrans_shift_breach(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Autotrans_shift_breachInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Autotrans_shift_breach_optimization_info();
    }

    finalize_c1_Autotrans_shift_breach
      ((SFc1_Autotrans_shift_breachInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_Autotrans_shift_breach
    ((SFc1_Autotrans_shift_breachInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Autotrans_shift_breach(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_Autotrans_shift_breach(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Autotrans_shift_breach_optimization_info();
...
static void mdlRTW_c1_Autotrans_shift_breach(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Autotrans_shift_breach(SimStruct *S)
{
  SFc1_Autotrans_shift_breachInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_Autotrans_shift_breachInstanceStruct *)utMalloc(sizeof
    (SFc1_Autotrans_shift_breachInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_Autotrans_shift_breachInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_Autotrans_shift_breach;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_Autotrans_shift_breach;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_Autotrans_shift_breach;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_Autotrans_shift_breach;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_Autotrans_shift_breach;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_Autotrans_shift_breach;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_Autotrans_shift_breach;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_Autotrans_shift_breach;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Autotrans_shift_breach;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Autotrans_shift_breach;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_Autotrans_shift_breach;
...
void c1_Autotrans_shift_breach_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Autotrans_shift_breach(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Autotrans_shift_breach(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Autotrans_shift_breach(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Autotrans_shift_breach_method_dispatcher.\n"
