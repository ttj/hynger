#include "__cf_Autotrans_shift.h"
#include <math.h>
#include "Autotrans_shift_acc.h"
#include "Autotrans_shift_acc_private.h"
#include <stdio.h>
#include "simstruc.h"
...
( S , 2 , 8 , SS_CALL_MDL_OUTPUTS ) ; } if ( ssIsSampleHit ( S , 1 , 0 ) ) {
ssCallAccelRunBlock ( S , 2 , 9 , SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock
( S , 2 , 10 , SS_CALL_MDL_OUTPUTS ) ; } if ( ssIsSampleHit ( S , 2 , 0 ) ) {
_rtB -> pmisg3cbvo = rt_Lookup ( _rtP -> P_17 , 4 , _rtB -> hsgy4zkqe3 , _rtP
-> P_18 ) ; } _rtB -> bg10zkj5cz = _rtP -> P_19 * n2rwvsubi1 ; n2rwvsubi1 =
_rtB -> pmisg3cbvo * _rtB -> bg10zkj5cz / _rtB -> nyeosjdjr3 ; ff0brfow4i =
_rtB -> nyeosjdjr3 / rt_Lookup ( _rtP -> P_20 , 21 , n2rwvsubi1 , _rtP ->
P_21 ) ; _rtB -> mnyoybtw5q = muDoubleScalarPower ( ff0brfow4i , 2.0 ) ; _rtB
-> dabnokrk2h = ( rt_Lookup2D_Normal ( _rtP -> P_14 , 10 , _rtP -> P_15 , 11
, _rtP -> P_16 , ( ( mtnexwdpxa * ) ssGetU ( S ) ) -> fsgwekhkkv , _rtB ->
nyeosjdjr3 ) - _rtB -> mnyoybtw5q ) * _rtP -> P_22 ; _rtB -> nu0aib4h3h =
_rtB -> mnyoybtw5q * rt_Lookup ( _rtP -> P_23 , 21 , n2rwvsubi1 , _rtP ->
P_24 ) * _rtB -> pmisg3cbvo ; _rtB -> nrmq2bn1zo = ( _rtP -> P_25 * _rtB ->
nu0aib4h3h - ( ( 0.02 * muDoubleScalarPower ( _rtB -> a35ha4xmd4 , 2.0 ) +
40.0 ) + ( ( mtnexwdpxa * ) ssGetU ( S ) ) -> clefvdrcq2 ) *
muDoubleScalarSign ( _rtB -> a35ha4xmd4 ) ) * _rtP -> P_26 ; UNUSED_PARAMETER
( tid ) ; }
#define MDL_UPDATE
...
; _rtP = ( ( loikxjbxjg * ) ssGetDefaultParam ( S ) ) ; _rtB = ( ( n3qi1whofz
* ) _ssGetBlockIO ( S ) ) ; _rtXdot -> azm34qp5pu = _rtB -> nrmq2bn1zo ; {
...
usat ) || ( lsat && ( _rtB -> dabnokrk2h > 0 ) ) || ( usat && ( _rtB ->
dabnokrk2h < 0 ) ) ) { ( ( pqmvzr1kvu * ) ssGetdX ( S ) ) -> kdcsyngxxk =
_rtB -> dabnokrk2h ; } else { ( ( pqmvzr1kvu * ) ssGetdX ( S ) ) ->
kdcsyngxxk = 0.0 ; } } } static void mdlInitializeSizes ( SimStruct * S ) {
ssSetChecksumVal ( S , 0 , 3700336789U ) ; ssSetChecksumVal ( S , 1 ,
60589022U ) ; ssSetChecksumVal ( S , 2 , 2671760613U ) ; ssSetChecksumVal ( S
, 3 , 2578778953U ) ; { mxArray * slVerStructMat = NULL ; mxArray * slStrMat
